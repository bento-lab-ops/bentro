...
const translations = {
    'en': {
        ...
        'modal.login_title': 'Login',
        'modal.register_title': 'Register',
        'modal.user_profile': 'User Profile',
        ...
        'btn.change_avatar': 'Change Avatar',
        'btn.save_changes': 'Save Changes',
        'msg.no_account': 'No account? Register',
        'msg.have_account': 'Have an account? Login',
        'msg.success': 'Success',
        'msg.error': 'Error',
        'msg.warning': 'Warning',
        ...
        'btn.guest_login': 'Continue as Guest',
        ...
        'label.card_content': 'Card Content',
        'btn.add_card': 'Add Card',
        ...
        'heading.teams': 'Teams',
        'subtitle.teams': 'Collaborate and manage your squads',
        'menu.help': 'Help',
        'menu.logout': 'Logout',
        'menu.unlock': 'Unlock',
        ...
        'admin.stat_total_teams': 'Total Teams',
        ...
        'admin.stat_active_boards': 'Active Boards',
        'admin.stat_total_actions': 'Total Action Items',
        'admin.stat_completed_actions': 'Completed Tasks',
        'label.votes_remaining': 'Votes Remaining',
        'label.votes_remaining': 'Votes Remaining',
        'btn.login': 'Login',
        'btn.signin_google': 'Sign in with Google',
        'btn.claim_host': 'Claim Host',
        'btn.claim_co_host': 'Join as Host',
        'btn.unclaim': 'Relinquish Control',
        'btn.admin_settings': 'Admin Settings',
        ...
        'help.shortcut.toggle_help': 'Toggle Help',
        'help.shortcut.close_modals': 'Close Modals',
        'help.shortcut.export_csv': 'Export CSV',
        'help.shortcut.toggle_timer': 'Toggle Timer',
        'help.shortcut.switch_phase': 'Switch Phase',
        'help.shortcut.new_card': 'New Card',
    ...
    'pt-BR': {
        ...
        'modal.change_name': 'Trocar Nome',
        'modal.login_title': 'Entrar',
        'modal.register_title': 'Criar Conta',
        'modal.user_profile': 'Perfil do Usuário',
        'modal.change_password': 'Trocar Senha',
        'label.email': 'Email',
        ...
        'label.display_name': 'Apelido (Como quer ser chamado)',
        'label.name': 'Nome Completo',
        'label.avatar': 'Avatar',
        'btn.register': 'Criar Conta',
        'btn.change_password': 'Trocar Senha',
        'btn.change_avatar': 'Trocar Avatar',
        'btn.save_changes': 'Salvar Alterações',
        'msg.no_account': 'Não tem conta? Cadastre-se',
        'msg.have_account': 'Já tem conta? Entre',
        'msg.success': 'Sucesso',
        'msg.error': 'Erro',
        'msg.warning': 'Aviso',
        'msg.profile_updated': 'Perfil atualizado com sucesso!',
        'msg.reg_success': 'Cadastro realizado com sucesso! Por favor, faça login.',
        'msg.password_changed': 'Senha alterada com sucesso!',
        'msg.email_readonly': 'Email não pode ser alterado',
        'msg.must_change_password': 'Você deve trocar sua senha antes de continuar',
        'msg.guest_option': 'Ou continue como convidado (Dados não salvos)',
        'btn.guest_login': 'Continuar como Convidado',
        ...
        'label.card_content': 'Conteúdo do Card',
        'btn.add_card': 'Adicionar Card',
        ...
        'heading.teams': 'Times',
        'subtitle.teams': 'Colabore e gerencie seus esquadrões',
        'menu.help': 'Ajuda',
        'menu.logout': 'Sair',
        ...
        'admin.stat_total_boards': 'Total de Retros',
        'admin.stat_active_boards': 'Retros Ativas',
        'admin.stat_total_actions': 'Total de Acionáveis',
        'admin.stat_completed_actions': 'Tarefas Concluídas',
        'admin.stat_total_teams': 'Total de Times',
        'admin.stat_total_users': 'Total de Usuários',
        ...
        'btn.claim_co_host': 'Entrar como Gestor',
        ...
        'template.custom': 'Personalizado (Entrada Manual)',
        ...
        'help.shortcut.toggle_help': 'Ajuda',
        'help.shortcut.close_modals': 'Fechar Modais',
        'help.shortcut.export_csv': 'Exportar CSV',
        'help.shortcut.toggle_timer': 'Alternar Timer',
        'help.shortcut.switch_phase': 'Trocar Fase',
        'help.shortcut.new_card': 'Novo Card',
